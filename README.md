...
Authentication Service Role: The Identity Provider (IdP).
...
git clone https://github.com/vghost18/smart-service-portal.git cd smart-service-portal
...
smart-service-portal/ ├── api-gateway/
├── auth-service/
├── request-service/
├── frontend/
└── README.md
